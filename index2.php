...
<head>
  ...
  <title>WebGIS PERSEBARAN SD di KECAMATAN TEMBALANG</title>
      ...
      <div class="header-container d-flex align-items-center">
        ...
        <nav class="nav-menu d-none d-lg-block">
          <ul>
            ...
            <li><a href="#portfolio">Data Sekolah Dasar</a></li>
        ...
        <div class="row">
          <div class="col-lg-3" data-aos="fade-right">
            <div class="section-title">
              <h2>Data SD</h2>
              <p>Halaman ini memuat informasi Persebaran SD di Kecamatan Tembalang </p>
            </div>
          </div>
                ...
                <div class="panel-body">
                  <table class="table table-bordered table-striped table-admin">
                    <thead>
                      <tr>
                        <th width="5%">No.</th>
                        <th width="30%">Nama SD</th>
                        <th width="30%">Alamat</th>
                        <th width="20%">Status SD</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
